...
import { FETCH_WORK_JOB_CATEGORY } from "../../../GraphQL/Query/WorkJob";
...
const CategoryList: NextPage = () => {
  ...
  const workJobOfProvince = data?.workJobOfCategory;
  const provinceDetail = data?.categoryDetail;
